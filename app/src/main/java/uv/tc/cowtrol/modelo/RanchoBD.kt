...
class RanchoBD (contexto: Context) : SQLiteOpenHelper(contexto, NOMBRE_BD, null, VERSION_BD) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val CREATE_TABLE_RANCHO = ("CREATE TABLE ${NOMBRE_TABLA} (${COL_NOMBRE} TEXT, ${COL_UBICACION} TEXT, ${COL_TELEFONO} INT, ${COL_PROVINCIA} TEXT,  PRIMARY KEY($COL_NOMBRE,$COL_UBICACION))")
